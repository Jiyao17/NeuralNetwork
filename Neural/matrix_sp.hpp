...
return the pointer to the result stored in a piece of new memory
...
public:
	...
	typedef std::shared_ptr<vector> matrix;
...
Matrix<T>& Matrix<T>::operator+=(const scalar &s)
{
	...
	std::cout << "M.operator+= scalar called." << std::endl;
